...
return {
    ...
    },
    {
      ...
      entries = {
        ...
        child_of("show_scrolling_input", checkbox_menu_item("Hide Negative Edge Inputs", training_settings, "skip_nedge_displays", false, "Reduce clutter in the input history by hiding button releases.")),
