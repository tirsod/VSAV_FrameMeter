local default_training_settings = {
  ...
  enable_slot_4=false,
  enable_slot_5=false,
  mo_enable_frame_data=false,   -- Added variables for
  display_action_timeline=true, -- decluttering frame data display.
  display_frame_meter=false,    -- My own variable to show the frame meter.
  fm_no_throw=false,
